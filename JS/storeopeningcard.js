  ...
  const storesData = [
    {
      ...
      name: "スイーツの鉄板焼き屋",
      description:
        "ふわふわのパンケーキ、甘くて美味しいクレープなど、心もとろけるスイーツを豊富にご用意しました。",
      location: "本館 1F",
      building: "本館",
    },
    {
      ...
      name: "ラーメン屋",
      description:
        "熱い麺、濃厚なスープ、厳選された具材。一杯一杯に心を込めて、皆様にお届けします。",
      location: "4号館 B1F",
      building: "4号館",
    },
    {
      ...
      name: "もちもち焼きそば",
      description:
        "自家製のもちもち麺と特製ソースが絡み合う絶品焼きそばです。野菜と肉もたっぷり入って、ボリューム満点！",
      location: "5号館 2F",
      building: "5号館",
    },
    {
      ...
      name: "タピオカドリンク",
      description:
        "本場の台湾タピオカを使用した、もっちもちの食感が楽しめるドリンクです。ミルクティーやフルーツティーなど、種類豊富にご用意しております。",
      location: "7号館 3F",
      building: "7号館",
    },
    {
      ...
      name: "焼き鳥屋",
      description:
        "炭火でじっくりと焼き上げた、香ばしい焼き鳥です。もも、ねぎま、つくねなど、定番から変わり種まで楽しめます。",
      location: "9号館 4F",
      building: "9号館",
    },
    {
      ...
      name: "かき氷屋",
      description:
        "ふわふわの氷と、自家製のシロップが絶妙なハーモニーを奏でます。暑い夏にぴったりの、冷たいスイーツをお楽しみください。",
      location: "本館 1F",
      building: "本館",
    },
  ];
    ...
    button.addEventListener("click", () => {
      ...
      if (activeBuildings.length === 0) {
        ...
        filteredStores = storesData.filter((store) =>
          activeBuildings.includes(store.building)
        );
      }
